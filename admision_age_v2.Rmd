...
base_actas_v1 <- fread("E:/Protocolos de investigación/CDMX/Defunciones corte 15 de marzo 2021/defunciones_corte15marzo.csv")[, sexo := if_else(sexo == "Mujer", "FEMENINO", "MASCULINO")][,
  fec_defuncion := ymd(fec_defuncion)
                                                                                                                                                     ...
                                                                                                                                                     fecingre=fec_defuncion-5)][,
                                                                                                                                                                      ...
                                                                                                                                                                      sexo,edad,lugarmuerte,causa_registro)][,`:=`(
...
mymodel_edad <- glm(no_hospitalizado ~ rcs(edad, 3)+semana_epi+rcs(porcentaje_ocupadas_uti_misma_fecha, 3)+tiene_comorbilidad+sexo, 
...
mymodel_edad_fecha_3 <- glm(no_hospitalizado ~ rcs(edad, 3)+semana_epi+rcs(porcentaje_ocupadas_uti_fecha_3, 3)+tiene_comorbilidad+sexo, 
                          data = train, family = 'binomial')
summary(mymodel_edad)
...
mymodel_edad_fecha_7 <- glm(no_hospitalizado ~ rcs(edad, 3)+semana_epi+rcs(porcentaje_ocupadas_uti_fecha_7, 3)+tiene_comorbilidad+sexo, 
                          data = train, family = 'binomial')
summary(mymodel_edad)
...
mymodel_edad_gr <- glm(no_hospitalizado ~ rcs(edad, 3)+semana_epi+rcs(porcentaje_ocupadas_general_misma_fecha, 3)+tiene_comorbilidad+sexo, 
                          data = train, family = 'binomial')
...
mymodel_edad_fecha_3_gr <- glm(no_hospitalizado ~ rcs(edad, 3)+semana_epi+rcs(porcentaje_ocupadas_general_fecha_3, 3)+tiene_comorbilidad+sexo, 
                          data = train, family = 'binomial')
summary(mymodel_edad)
...
mymodel_edad_fecha_7_gr <- glm(no_hospitalizado ~ rcs(edad, 3)+semana_epi+rcs(porcentaje_ocupadas_general_fecha_7, 3)+tiene_comorbilidad+sexo, 
                          data = train, family = 'binomial')
summary(mymodel_edad)
...
############################################################################
#COMORBILIDADES COMO FACTOR
mymodel_edad_comor <- glm(no_hospitalizado ~ rcs(edad, 3)+semana_epi+rcs(porcentaje_ocupadas_uti_misma_fecha, 3)+numero_comorbilidades_factor+sexo, 
                          data = train, family = 'binomial')
summary(mymodel_edad_comor)


lr_edad_comor <- termplot(mymodel_edad_comor, se=TRUE, plot = F)$edad
center_edad_comor <- with(lr_edad_comor, y[x==60])
ci_edad_comor <- lr_edad_comor$y + outer(lr_edad_comor$se, c(0, -1.96, 1.96), '*')

edad_df_comor <- data.frame(edad = lr_edad_comor$x, 
                     y = lr_edad_comor$y,
                     se = lr_edad_comor$se,
                     lower_ci = ci_edad_comor[,2],
                     upper_ci = ci_edad_comor[,3],
                     mean_ci = ci_edad_comor[,1])


edad_ors_comor <- edad_df_comor[with(edad_df_comor, edad == 20 | edad == 30 | edad == 40 | 
                         edad == 50 |edad== 60|edad== 70|edad== 80|edad== 90),] %>% 
  mutate(or = round(exp(y-center_edad_comor),2),
         lower_or = round(exp(lower_ci-center_edad_comor),2),
         upper_or = round(exp(upper_ci-center_edad_comor),2),
         full_or = str_c(round(exp(y-center_edad_comor),2), " (", round(exp(lower_ci-center_edad_comor),2),
                         "-", round(exp(upper_ci-center_edad_comor),2),")"))
...
combined_plot <- age_spline_plot_fecha_3+age_spline_plot_fecha_7+age_spline_plot_gr+age_spline_plot_fecha_3_gr+age_spline_plot_fecha_7_gr+
